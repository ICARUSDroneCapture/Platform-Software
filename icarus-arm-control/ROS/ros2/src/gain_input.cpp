...
public:
    ...
    { 
        // Gain publisher
        pub_intertial_          = this->create_subscription<icarus_arm_control::msg::ControllerStatus>("controller_status", 1, std::bind(&LoggerNode::cbCtrlStatusData, this, std::placeholders::_1));
